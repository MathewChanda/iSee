...
//  iSee
//
//  Created by Mathew Chanda on 5/13/21.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    // scenekit - rendering the information card and create AR view for us
    // spritekit - create the card info
    // uses arkit - to detect objects from models
    ...
    override func viewDidLoad() {
     ...
     func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
         ...
         if let objectAnchor = anchor as? ARObjectAnchor {
             let plane = SCNPlane(width: CGFloat(objectAnchor.referenceObject.extent.x * 1.4), height: CGFloat(objectAnchor.referenceObject.extent.y * 1.2))
